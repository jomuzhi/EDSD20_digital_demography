...
1. Download Familinx sample data for Sweden: https://github.com/alburezg/EDSD20_digital_demography/tree/master/Assignment
1. Use the script in the `Assignment/R` directory to load it in your R global environment
1. Review the assignement instructions in the syllabus